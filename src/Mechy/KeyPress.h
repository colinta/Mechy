...
#define KC_NAV KC(DATA_MOD_LGUI | DATA_MOD_LCTL | DATA_MOD_LALT)

#define DATA_MOD_LSFT (1 << 8)
#define DATA_MOD_LGUI (1 << 9)
#define DATA_MOD_LCTL (1 << 10)
#define DATA_MOD_LALT (1 << 11)
#define DATA_MOD_ANY  (0b111100000000)

#define LSFT(k) ((k) | DATA_MOD_LSFT)
#define LGUI(k) ((k) | DATA_MOD_LGUI)
#define LCTL(k) ((k) | DATA_MOD_LCTL)
#define LALT(k) ((k) | DATA_MOD_LALT)
