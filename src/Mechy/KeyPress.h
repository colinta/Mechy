...
#define KC_HYP KC((DATA_MOD_LSFT | DATA_MOD_LGUI | DATA_MOD_LCTL | DATA_MOD_LALT) << EVENT_DATA_SHIFT)
#define KC_MEH KC((DATA_MOD_LSFT | DATA_MOD_LCTL | DATA_MOD_LALT) << EVENT_DATA_SHIFT)
#define KC_CAG KC((DATA_MOD_LGUI | DATA_MOD_LCTL | DATA_MOD_LALT) << EVENT_DATA_SHIFT)
