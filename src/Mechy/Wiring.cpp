...
volatile uint8_t* _directionRegisterPtr(uint8_t pin);
volatile uint8_t* _portRegisterPtr(uint8_t pin);
...
void _ddrModeOutput(uint8_t pin) {
    volatile uint8_t* ddr = _directionRegisterPtr(pin);
    uint8_t pinMask = _pinMask(pin);
    bit_on(*ddr, pinMask);
}
...
void _pinOutputLow(uint8_t pin) {
    volatile uint8_t* port = _portRegisterPtr(pin);
    uint8_t pinMask = _pinMask(pin);
